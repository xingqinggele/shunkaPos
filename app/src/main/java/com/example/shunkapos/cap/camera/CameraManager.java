...
package com.example.shunkapos.cap.camera;
...
import com.example.shunkapos.cap.android.CaptureActivityHandler;
...
public final class CameraManager {
    ...
    public CameraManager(Context context, ZxingConfig config,double high,double wid) {
...
//    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int width = (int) (screenResolutionX * wid);
            int width1 = (int) (screenResolutionX * high);
            int height = width1;
