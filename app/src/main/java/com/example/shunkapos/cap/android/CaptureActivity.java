package com.example.shunkapos.cap.android;
...
import com.example.shunkapos.cap.camera.CameraManager;
import com.example.shunkapos.cap.common.Constant;
import com.example.shunkapos.cap.decode.DecodeImgCallback;
import com.example.shunkapos.cap.decode.DecodeImgThread;
import com.example.shunkapos.cap.decode.ImageUtil;
import com.example.shunkapos.cap.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    //新增扫描框高度
    private double high = 0.4;
    //新增扫描框宽度
    private double wid = 0.8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wid = getIntent().getDoubleExtra("wid",0);
        high = getIntent().getDoubleExtra("hei",0);
        Log.e("宽高----->",wid +"====" + high);
    ...
    protected void onResume() {
        ...
        cameraManager = new CameraManager(getApplication(), config,wid,high);
