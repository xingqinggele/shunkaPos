...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if (arg1 == null) {
            ...
            arg1 = View.inflate(context, R.layout.item_menu_integramost_list, null);
        ...
        if (arg0 == selectItem) {
            ...
            holder.tv_name.setTextColor(context.getResources().getColor(R.color.new_theme_color));
        } else {
            holder.tv_name.setBackgroundColor(context.getResources().getColor(R.color.background));
            holder.tv_name.setTextColor(context.getResources().getColor(R.color.integra_tv_color));
        }
